describe('Subscription', function()
  ...
  describe('unsubscribe', function()
    ...
    it('does not run the action more than once', function()
      local unsubscribe = spy()
      local subscription = Rx.Subscription.create(unsubscribe)
      subscription:unsubscribe()
      subscription:unsubscribe()
    ...
    it('does not run the action more than once when it recursively unsubscribes', function()
      local subscription
      local unsubscribe = spy(function() subscription:unsubscribe() end)
      subscription = Rx.Subscription.create(unsubscribe)
      subscription:unsubscribe()
      subscription:unsubscribe()
      subscription:unsubscribe()
      expect(#unsubscribe).to.equal(1)
