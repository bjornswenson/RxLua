describe('ReplaySubject', function()
  ...
  describe('subscribe', function()
    ...
    describe('if the subject has received an error', function()
      it('drops new values', function()
        local subject = Rx.ReplaySubject.create(2)
  ...
  describe('onNext', function()
    ...
    describe('if the subject has already completed', function()
      it('does not push values to subscribers when already completed', function()
        local observers = {}
        local spies = {}
        for i = 1, 2 do
          observers[i] = Rx.Observer.create()
        ...
        subject:onCompleted()
        subject:onNext(3)
        expect(spies[1]).to.equal({{1}, {2}})
        expect(spies[2]).to.equal({{1}, {2}})
      end)
    end)

    describe('if the subject has received an error', function()
      it('does not push values to subscribers when previously received an error', function()
        local observers = {}
        local spies = {}
        for i = 1, 2 do
